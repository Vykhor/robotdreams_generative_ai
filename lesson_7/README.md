...
### 2. **`model/Discriminator.py та model/DiscriminatorWithMinibatch.py`**
...
### 6. **`TrainingProcess.py та TrainingProcessWithFeatures.py`**
...
- Результати різних ітерацій розробки та підбору параметрів знаходяться у папках 1-5 та містять пояснення, натреновані моделі та приклади згенерованих даних.
