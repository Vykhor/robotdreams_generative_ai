...
for epoch in range(p_epochs):
    ...
    for i, (real_images, _) in enumerate(training_loader):
        ...
        real_output_d, real_features = discriminator_with_features(mnist_discriminator, real_images)
        ...
        for _ in range(p_generator_iterations):
            ...
            generator_with_features_loss = generator_loss + p_feature_loss_weight * feature_loss
