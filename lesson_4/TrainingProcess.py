...
from lesson_4.plot.ConfusionMatrix import plot_confusion_matrix
from lesson_4.plot.LossAndAccuracy import plot_loss_and_accuracy
from lesson_4.plot.Predictions import plot_predictions
from models.MnistCNNModel import create_model
...
training_data = load_dataset_csv("./datasets/training_data.csv")
test_data = load_dataset_csv("./datasets/test_data.csv")
